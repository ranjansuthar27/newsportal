...
include('includes/config.php');
  ...
  /* echo $query="SELECT `CategoryName`, `subcat_name`,`subcat_des` FROM tblsubcategory WHERE id='$cid' ";*/
   $query = "SELECT
    ...
    if (isset($_POST['submit'])) {
         ...
         $queryEdit = "UPDATE `tblsubcategory` SET `cat_id`='$CategoryName',`subcat_name`='$subCatName',`subcat_des`='$subCatDescription',`updated_at`='$date' WHERE cat_id = $cid";
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-6 col-sm-6">
                                        ...
                                        <div class="card-box widget-box-one" style="background-color: #5599e3;">
                                            <select style="width: 247px;height:45px;" name="CategoryName">
                                                ...
                                                while ($response = mysqli_fetch_assoc($resultCat)) {
                                                    ?>
                                                    <option value="<?php echo $response['id']; ?>"<?php if ($response['id']==$total['cat_id']) {
                                                        echo "selected";
                                                    }  ?>><?php echo $response['CategoryName']; ?>
                                    ...
                                    <div class="col-lg-12 col-md-6 col-sm-6">
                                        ...
                                        <div class="card-box widget-box-one" style="background-color: #5599e3;">
                                           <input style="width: 247px;height: 56px;" type="text" name="SubCategoryName" placeholder="SubCategoryName" required="" value="<?php echo $total['subcat_name'];  ?>">
                                        </div>
                                    </div>
                                <!-- end col -->
                                    ...
                                    <div class="col-lg-12 col-md-6 col-sm-6">
                                        ...
                                        <div class="card-box widget-box-one" style="background-color: #5599e3;">
                                           <textarea type="text" rows="4" cols="50" name="SubCateDescription" placeholder="SubCategoryDescription" required=""><?php echo $total['subcat_des'];?></textarea> 
                                        </div>
                                    </div>
                                <!-- end col -->
                            </div>
