...
include('includes/config.php');
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = "INSERT INTO `tblcategory`(`id`, `CategoryName`, `Description`, `Is_Active`) VALUES ('','$CategoryName','$Description','1')";
                            ...
                            <div class="row">
                                ...
                                <!-- end col -->
                                    ...
                                    <div class="col-lg-12 col-md-6 col-sm-6">
                                        ...
                                        <div class="card-box widget-box-one" style="background-color: #5599e3;">
                                           <textarea type="text" rows="4" cols="50" name="Description" placeholder="Description" required=""></textarea> 
                                        </div>
                                    </div>
                                <!-- end col -->
                            </div>
