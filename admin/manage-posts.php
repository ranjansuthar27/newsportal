...
if ($_GET['action'] == 'parmdel') {
    $rid = $_GET['rid'];
   $query = "UPDATE `postdetails` SET `Is_Active`='0' WHERE id='$rid'";
                ...
                <div class="content">
                    ...
                    <tr class="bg-info text-dark">
                        ...
                        <td style="font-size: 20px;">
                            <a href="edit-posts.php?resid=<?php echo $response['id']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true" role="button">edit</i></a>&nbsp;&nbsp;&nbsp;
                            <a href="manage-posts.php?rid=<?php echo $response['id']; ?>&&action=parmdel"><i class="fa fa-trash" aria-hidden="true" role="button">delete</i></a>
                        </td>
                    </tr>
                 </tbody>
