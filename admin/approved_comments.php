...
if (isset($_GET['aid'])) {
    ...
    $query_approve = "UPDATE `comments` SET `is_active`='0' WHERE id='$aid'";
    $result_approve = mysqli_query($conn,$query_approve);


    if ($result_approve) {
        echo "<script>alert('Comment DisApproved')</script>";
    } 
}
...
if ($_GET['action'] == 'del') {
    ...
    $query_delete = "DELETE FROM `comments` WHERE id = '$did'";
                    ...
                    <tr class="bg-info text-dark">
                        ...
                        <td><?php echo $response['created_at']; ?></td>
                            <td style="font-size: 20px;">
                                <a href="approved_comments.php?aid=<?php echo $response['id']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true" role="button">Disapproved</i></a>&nbsp;&nbsp;&nbsp;
                                <a href="approved_comments.php?did=<?php echo $response['id']; ?>&&action=del"><i class="fa fa-trash" aria-hidden="true" role="button">Delete</i></a>
                            </td>
                    </tr>
                 </tbody>
