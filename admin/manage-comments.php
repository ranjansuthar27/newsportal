                    ...
                    <tr class="bg-info text-dark">
                        ...
                        <td><?php echo $response['created_at']; ?></td>
                            <td style="font-size: 20px;">
                                <a href="edit-categories.php?cid=<?php echo $response['id']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true" role="button"></i></a>&nbsp;&nbsp;&nbsp;
                                <a href="manage-categories.php?rid=<?php echo $response['id']; ?>&&action=del"><i class="fa fa-trash" aria-hidden="true" role="button"></i></a>
                            </td>
                    </tr>
                 </tbody>
