...
if ($_GET['action'] == 'del') {
    ...
    $query = "UPDATE `tblcategory` SET `Is_Active`='0' WHERE id='$rid'";
...
if ($_GET['action'] == 'parmdel') {
    ...
    $query = "DELETE FROM `tblcategory` WHERE id = '$rid'";
    $result = mysqli_query($conn,$query);

    if ($result) {
        $success = "Category Permantly Deleted";
    } else {
        $error = "Error";
    }
}
    ...
    <?php include('includes/leftsidebar.php');?>
            ...
            <div class="content-page">
                ...
                <div class="content">
                        ...
                        <form method="POST">
                            <div class="row">
                                <div class="col-lg-12 col-md-6 col-sm-6">
                                     <a href="add-category.php" style="color: white;"><button type="submit" class="btn btn-primary" name="submit">Add</a></button>
                                </div>
                            </div>
                    ...
                    <tr class="bg-info text-dark">
                        ...
                        <td><?php echo $response['PostingDate']; ?></td>
                        <td><?php echo $response['UpdationDate']; ?></td>
                        <td style="font-size: 20px;">
                            <a href="edit-categories.php?cid=<?php echo $response['id']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true" role="button">edit</i></a>&nbsp;&nbsp;&nbsp;
                            <a href="manage-categories.php?rid=<?php echo $response['id']; ?>&&action=del"><i class="fa fa-trash" aria-hidden="true" role="button">delete</i></a>
                        </td>
                    </tr>
                 </tbody>
            ...
            ?>
                ...
                <div class="container">
                        ...
                        <table class="table table-hover" style="margin-top:50px;">
                            <h1 class="text-primary">Deleted Category</h1>
                                <thead class="thead-dark bg-dark text-white" style="font-size: 20px;">
                                <tr>
                                    <th>SL.NO</th>
                                    <th>CategoryName</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-info text-dark">
                                        ...
                                        <td><?php echo $response['UpdationDate']; ?></td>
                                        <td style="font-size: 20px;">
                                            <a href="manage-categories.php?resid=<?php echo $response['id']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true" role="button">restore</i></a>&nbsp;&nbsp;&nbsp;
                                            <a href="manage-categories.php?rid=<?php echo $response['id']; ?>&&action=parmdel"><i class="fa fa-trash" aria-hidden="true" role="button">delete</i></a>
                                        </td>
                                    </tr>
                                </tbody>
