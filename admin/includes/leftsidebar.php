                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                  <li><a href="waiting_approval.php">Waiting for Approval </a></li>
                                    <li><a href="approved_comments.php">Approved Comments</a></li>
                                </ul>
                            </li>   
                   ...
                   /*  print_r ($_SESSION);
                    ...
                    <div class="help-box">
                        ...
                        <p class=""><span class="text-custom">Email:</span> <br/> <?php echo $_SESSION['login'];  ?></p>
                    </div>
